...
of those stores, 260 MiB here, shared by every core — they arrive at
...
| 8B in bf16 on an H100, whose weights sit in **HBM** (the fast memory attached to an accelerator) | 16 GB ÷ 3.35 TB/s = 4.8 ms per token | <!-- defines: hbm -->
