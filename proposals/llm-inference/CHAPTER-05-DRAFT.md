...
<!-- defines: service level objective -->
...
making the experience worse than you promised. That written promise is
a **service level objective**, or SLO. This chapter is about
...
**Goodput.** <!-- defines: goodput -->Throughput that actually met the promise. A server
...
>
> <!-- defines: percentile, median -->
> A **percentile** describes a real experience. The **p50**, or
> **median**, is the middle value — what a typical request gets. The **p99** is what the unluckiest
...
<!-- defines: queueing -->
**Queueing is not modelled either.** When requests arrive faster than
they can be served they wait in line — that waiting is **queueing**,
and it is why a service degrades sharply rather than gradually.
