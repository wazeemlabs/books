...
the paging of {{ch:paged-attention}} and the step-by-step
scheduling of {{ch:continuous-batching}}. What differs is the idea each one was
built around.
...
- **SGLang** — built around **reusing shared prefixes**. Its **radix
  ...
  which
  {{ch:prefix-caching}} builds, makes it
