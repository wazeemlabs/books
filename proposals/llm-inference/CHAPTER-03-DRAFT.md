...
| **Chunked prefill** (Chapter 18) — reading a long prompt a few hundred tokens at a time rather than all at once | both, by arbitrating | stops a long prompt stalling everyone's decode | <!-- defines: chunked prefill -->
